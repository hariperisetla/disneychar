      ...
      <nav className="bg-gray-900 border-b border-b-slate-700 p-5 flex items-center">
        <div>
          <Link href="/" className="block ">
            <h1 className="cursor-pointer text-3xl text-white">Disney Chars</h1>
          </Link>
        </div>

        <div className="text-slate-400 ml-auto text-xl space-x-8 cursor-pointer">
          <Link href="/" className="">
          ...
          <Link href="characters" className="hover:text-white">
            <span className="hover:text-white">Characters</span>
          </Link>
